...
<?php include "../navi/topmenu.html"; ?><br>
	...
	<br><b>Käyttöohje</b>: Valitse vasemman reunan aakkostaulukosta haluamasi alkukirjain, ja selaa sivulta etsimääsi tietoa.
	...
	<p>
	Tästä hakuaku<a href="../liitteet/WGdict.html"> englannista suomeksi</a>
...
<tr>
<td><a NAME="I"></a><font color="#FF0000"><font size=+2>I</font></font></td>
...
<tr>
<td><a NAME="J"></a><font color="#FF0000"><font size=+2>J</font></font></td>
...
<tr>
  <td> karkaistu lasi</td>
    <td> Lasia voidaan karkaista iskunkestävämmäksi puhaltamalla
    kylmää ilmaa kuumennettuun pintaan. Syntyy puristusjännitys joka
    lisää lasin kestävyyttä. Esim. autojen sivuikkunat, "Särkymättömät" juomalasit. <br>
    <br>
...
<tr>
  <td> kertamuotti</td>
  <td> muotti joka ei ole päästävä tai muusta syystä tarkoitettu rikottavaksi
...
<tr>
  <td>Kiteytymisalue</td>
  <td> Lämpöalue joskä yläpuolella lasi on selvästi nestettä. Kiteytymisalueella
  on mahdollista aineen järjestäytyminen kiteiseksi. Lasin viskositeetti on
  niin suuri että se voidaan jäähdyttää kiteytymisalueen alapuolelle ennen kiteiden
...
<tr>
  <td>Kohofuusaus   </td>
  <td> Fuusauksen aste, pintafuusauksen ja syväfuusauksen välillä,
  jossa palojen rajat eivät enää tunnu mutta pinta ei myöskään ole 
...
<tr>
  <td> Kristalli</td>
    <td> Lasiterminä se sai nimensä Muranossa 1400-luvulla kun opittiinn
    värittömän lasin valmistus, jota verrattiin luonnon vuorikristalliin.
    Termiä käytetään myös kaiverretusta sooda-lasista 
    <a href="./sanasto0.php#boomi">"Böömiläinen kristalli" </a>
    ja 1600-luvulla keksitystä lyijylasista.
    <br>
...
<tR>
  <td> kuorittu lasi</td>
    <td> Pintakäsittelymenetelmä, jossa lasin pinnalle levitetään vahva liima.
...
<tr>
<td><a NAME="L"></a><font color="#FF0000"><font size=+2>L</font></font></td>
...
<tr>
  <td> Laminoiminen</td>
  <td>
  1. menettely jossa muita aineita kuin lasia suljetaan
  kahden lasin väliin sulattamalla lasit yhteen. Esim panssarilasi, jossa metalliverkko on laminoiyu kahdeen
  lasin väliin kiinteäksi osaksi kokonaisuutta.
  2. Uunisulatuksen terminä työtapa jossa muita aineita kuten metallifoliota, metallilankaa,
...
<tr>
  <td> <a name="lasimurska"></a>Lasimurska</td>
  <td> eli <i>fritti</i> on murskattua lasia jonka palakoko voi olla
...
<tr>
  <td> <a name="lasite"></a>Lasite </td>
  <td> myös flussi, overspray. Hieno lasijauhe jota sideaineeseen sekoitettuna
...
<tr>
  <td>Leikkausöljy   </td>
  <td> Ohut öljy, jolla kastellaan lasiveitsen rissa. 
  Öljyveitsessä se tulee varressa olevasta säiliöstä, 
...
<tr>
<td><a NAME="N"></a><font color="#FF0000"><font size=+2>N</font></font></td>

<td></td><td></td>
</tr>
<tr>
  <td> nestemäinen</td>
  <td> Aineen olomuoto, jossa molekyylien varaama lämpöenergia on niin suuri että molekyylit pääsevät liikkumaan toistensa
  ohitse vapaasi, mutta eivät kokonaan irtautumaan. Nestettä alemmassa
...
<td><a NAME="O"></a><font color="#FF0000"><font size=+2>O</font></font></td>

<td></td><td></td>
</tr>
<tr>
  <td>Ominaispaino</td>
  <td> Aineen tilavuuden ja massa suhde.
...
<tr>
  <td> Overspray</td>
    <td> Lasite, jolla saadaan kiiltoa lasin pintaan.
...
<tr>
<td><a NAME="P"></a><font color="#FF0000"><font size=+2>P</font></font></td>

<td></td><td></td>
</tr>
<tr> 
  <td> <a name="Pate_de_verre"></a>Pate de Verre </td>
...
<tr>
  <td> Polarisoitunut valo</td>
  <td> valo on poikittaista aaltoliikettä Samoin kuin veden aallot.
  Vedessä aallot voivat olla poikittain vain pintaan nähden. Valoaallot voivat
  olla eri suuntiin popikittaisia, ilman polariteettiä. Heijastavat
  pinnat yleensä heijastavat paremmin pintaa vastaan kohtisuoraa valoa.
Siihen perustuu polarisoivien aurinkolasien etu. <br>
Voidaan myös valmistaa suodattimia, joilla on kyky valikoida mihin suuntaan
...
<tr>
<td><a NAME="Q"></a><font color="#FF0000"><font size=+2>Q</font></font></td>

<td></td><td></td>
</tr>

<tr>
<td><a NAME="R"></a><font color="#FF0000"><font size=+2>R</font></font></td>
<tr>
  <td> Rengasmuotti</td>
...
<tr>
    <td> <a NAME="Ruukkusulatus"></a>Ruukkusulatus</td>
    <td> lasin 
