...
<tr width="20%">
  <td  bgcolor="#ffffff">
     ...
     <table  border bgcolor="#e0ffe0">
       <td>         
          <a href="  ./navi-tutustu.html" > Tutustumiskierros <br> suunnistus </a>
      </td>      
     </table>
   </td>
 <!---END vasen--->
<!---TEKSTI --->
 ...
 <td bgcolor="#ffffff"  >
    <?php include "./leikkaaminen1.html"; ?>
</td>
<td
<!--- END TEKSTI --->
    <!--- KUVAT --->
...
<tr>
  <td  >
  Edellinen sivu    <A href="../tutustu/uunityo.php"> Uunityö</A> <br>
    takaisin <A href="../index.php"> alkusivulle</A> 
    </td>
    <td>
    <p align=right> Jatka ->
   <A href="leikkaaminen2.php"> Leikkaaminen2 </A>
  </td>
  </tr>
</table>
<!--- END-ALALINKIT --->
